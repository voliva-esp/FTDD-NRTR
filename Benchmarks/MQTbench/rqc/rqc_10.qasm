...
// Qubits: [(1, 5), (1, 6), (1, 7), (2, 4), (2, 5), (2, 6), (2, 7), (3, 3), (3, 4), (3, 5), (3, 6), (3, 7), (4, 2), (4, 3), (4, 4), (4, 5), (4, 6), (4, 7), (5, 2), (5, 3), (5, 4), (5, 5), (5, 6), (6, 2), (6, 3), (6, 4), (6, 5), (7, 2), (7, 3), (7, 4)]
qreg q[30];
...
rz(pi*-0.2254238777) q[18];
rz(pi*0.2814659584) q[19];
rz(pi*-0.331134634) q[20];
rz(pi*0.4044070452) q[21];
rz(pi*-0.408126244) q[23];
rz(pi*0.3666829187) q[24];
rz(pi*-0.3507308388) q[25];
rz(pi*0.3755464949) q[26];
rz(pi*-1.4187954354) q[27];
rz(pi*1.5102819374) q[28];
...
ry(pi*-0.5) q[18];
ry(pi*-0.5) q[19];
rz(pi*0.4687928849) q[18];
rz(pi*0.4687928849) q[19];
u3(pi*0.5,pi*1.0,pi*1.0) q[18];
u3(pi*0.5,0,pi*1.0) q[19];
sx q[18];
cx q[18],q[19];
rx(pi*0.0312071151) q[18];
ry(pi*0.5) q[19];
cx q[19],q[18];
sxdg q[19];
s q[19];
cx q[18],q[19];
u3(pi*0.5,pi*1.5312071151,0) q[18];
u3(pi*0.5,pi*1.5312071151,pi*1.0) q[19];
ry(pi*0.5) q[18];
ry(pi*0.5) q[19];
sx q[18];
sx q[19];
...
sxdg q[18];
sxdg q[19];
u3(pi*0.5,pi*1.0,pi*1.5273290185) q[18];
u3(pi*0.5,0,pi*1.0273290185) q[19];
sx q[18];
cx q[18],q[19];
rx(pi*0.4275456147) q[18];
ry(pi*0.5) q[19];
cx q[19],q[18];
sxdg q[19];
s q[19];
cx q[18],q[19];
u3(pi*0.5,pi*1.4002165961,0) q[18];
u3(pi*0.5,pi*1.9002165961,pi*1.0) q[19];

// Gate: cirq.FSimGate(theta=1.5346175385256955, phi=0.5131039467233695)
ry(pi*-0.5) q[20];
ry(pi*-0.5) q[21];
rz(pi*0.488483934) q[20];
rz(pi*0.488483934) q[21];
u3(pi*0.5,pi*1.0,pi*0.6625195139) q[20];
u3(pi*0.5,0,pi*1.6625195139) q[21];
sx q[20];
cx q[20],q[21];
rx(pi*0.011516066) q[20];
ry(pi*0.5) q[21];
cx q[21],q[20];
sxdg q[21];
s q[21];
cx q[20],q[21];
u3(pi*0.5,pi*1.848996552,0) q[20];
u3(pi*0.5,pi*0.848996552,pi*1.0) q[21];
ry(pi*0.5) q[20];
ry(pi*0.5) q[21];
sx q[20];
sx q[21];
...
sxdg q[20];
sxdg q[21];
u3(pi*0.5,0,pi*1.0854789221) q[20];
u3(pi*0.5,pi*1.0,pi*1.5854789221) q[21];
sx q[20];
cx q[20],q[21];
rx(pi*0.4183369706) q[20];
ry(pi*0.5) q[21];
cx q[21],q[20];
sxdg q[21];
s q[21];
cx q[20],q[21];
u3(pi*0.5,pi*1.8328580485,pi*1.0) q[20];
u3(pi*0.5,pi*1.3328580485,0) q[21];

// Gate: cirq.FSimGate(theta=1.5169062231051558, phi=0.46319906116805815)
ry(pi*-0.5) q[23];
ry(pi*-0.5) q[24];
rz(pi*0.4828462472) q[23];
rz(pi*0.4828462472) q[24];
u3(pi*0.5,pi*1.0,pi*1.5) q[23];
u3(pi*0.5,0,pi*0.5) q[24];
sx q[23];
cx q[23],q[24];
rx(pi*0.0171537528) q[23];
ry(pi*0.5) q[24];
cx q[24],q[23];
sxdg q[24];
s q[24];
cx q[23],q[24];
u3(pi*0.5,pi*1.0171537528,0) q[23];
u3(pi*0.5,pi*0.0171537528,pi*1.0) q[24];
ry(pi*0.5) q[23];
ry(pi*0.5) q[24];
sx q[23];
sx q[24];
...
sxdg q[23];
sxdg q[24];
u3(pi*0.5,0,pi*0.0788165235) q[23];
u3(pi*0.5,pi*1.0,pi*0.5788165235) q[24];
sx q[23];
cx q[23],q[24];
rx(pi*0.4262795798) q[23];
ry(pi*0.5) q[24];
cx q[24],q[23];
sxdg q[24];
s q[24];
cx q[23],q[24];
u3(pi*0.5,pi*0.8474630563,pi*1.0) q[23];
u3(pi*0.5,pi*0.3474630563,0) q[24];

// Gate: cirq.FSimGate(theta=1.5705414623224259, phi=0.4791699064049766)
ry(pi*-0.5) q[25];
ry(pi*-0.5) q[26];
rz(pi*0.4999188741) q[25];
rz(pi*0.4999188741) q[26];
u3(pi*0.5,0,pi*1.0) q[25];
u3(pi*0.5,pi*1.0,pi*2.0) q[26];
sx q[25];
cx q[25],q[26];
rx(pi*8.11259e-05) q[25];
ry(pi*0.5) q[26];
cx q[26],q[25];
sxdg q[26];
s q[26];
cx q[25],q[26];
u3(pi*0.5,pi*1.5000811259,pi*1.0) q[25];
u3(pi*0.5,pi*0.5000811259,0) q[26];
ry(pi*0.5) q[25];
ry(pi*0.5) q[26];
sx q[25];
sx q[26];
...
sx q[25];
cx q[25],q[26];
rx(pi*0.4237377408) q[25];
ry(pi*0.5) q[26];
cx q[26],q[25];
sxdg q[26];
s q[26];
cx q[25],q[26];
u3(pi*0.5,pi*1.1737377408,0) q[25];
u3(pi*0.5,pi*0.6737377408,pi*1.0) q[26];

// Gate: cirq.FSimGate(theta=1.5516764540193888, phi=0.505545707839895)
ry(pi*-0.5) q[27];
ry(pi*-0.5) q[28];
rz(pi*0.4939139555) q[27];
rz(pi*0.4939139555) q[28];
u3(pi*0.5,0,pi*1.5) q[27];
u3(pi*0.5,pi*1.0,pi*0.5) q[28];
sx q[27];
cx q[27],q[28];
rx(pi*0.0060860445) q[27];
ry(pi*0.5) q[28];
cx q[28],q[27];
sxdg q[28];
s q[28];
cx q[27],q[28];
u3(pi*0.5,pi*1.0060860445,pi*1.0) q[27];
u3(pi*0.5,pi*0.0060860445,0) q[28];
ry(pi*0.5) q[27];
ry(pi*0.5) q[28];
sx q[27];
sx q[28];
...
sxdg q[27];
sxdg q[28];
u3(pi*0.5,0,pi*1.078876597) q[27];
u3(pi*0.5,pi*1.0,pi*0.578876597) q[28];
sx q[27];
cx q[27],q[28];
rx(pi*0.4195399016) q[27];
ry(pi*0.5) q[28];
cx q[28],q[27];
sxdg q[28];
s q[28];
cx q[27],q[28];
u3(pi*0.5,pi*1.8406633047,pi*1.0) q[27];
u3(pi*0.5,pi*0.3406633047,0) q[28];
...
rz(pi*0.7948295009) q[18];
rz(pi*-0.7387874203) q[19];
rz(pi*0.0493419494) q[20];
rz(pi*0.0239304618) q[21];
rz(pi*0.4710627118) q[23];
rz(pi*-0.5125060371) q[24];
rz(pi*2.1645856475) q[25];
rz(pi*-2.1397699914) q[26];
rz(pi*1.277311792) q[27];
rz(pi*-1.18582529) q[28];
sx q[0];
sx q[1];
sx q[2];
sx q[3];
...
rz(pi*0.7811374803) q[19];
rz(pi*-0.6780279413) q[20];
rz(pi*1.8635737986) q[21];
rz(pi*-2.1504123921) q[22];
rz(pi*2.3134893227) q[24];
rz(pi*-2.2384934207) q[25];
rz(pi*1.4263074183) q[28];
rz(pi*-1.527034178) q[29];
...
ry(pi*-0.5) q[19];
ry(pi*-0.5) q[20];
rz(pi*0.4901359579) q[19];
rz(pi*0.4901359579) q[20];
u3(pi*0.5,pi*1.0,pi*1.0) q[19];
u3(pi*0.5,0,pi*1.0) q[20];
sx q[19];
cx q[19],q[20];
rx(pi*0.0098640421) q[19];
ry(pi*0.5) q[20];
cx q[20],q[19];
sxdg q[20];
s q[20];
cx q[19],q[20];
u3(pi*0.5,pi*1.5098640421,0) q[19];
u3(pi*0.5,pi*1.5098640421,pi*1.0) q[20];
ry(pi*0.5) q[19];
ry(pi*0.5) q[20];
sx q[19];
sx q[20];
...
sx q[19];
cx q[19],q[20];
rx(pi*0.4176450257) q[19];
ry(pi*0.5) q[20];
cx q[20],q[19];
sxdg q[20];
s q[20];
cx q[19],q[20];
u3(pi*0.5,pi*1.6676450257,0) q[19];
u3(pi*0.5,pi*0.1676450257,pi*1.0) q[20];

// Gate: cirq.FSimGate(theta=1.4593314109380113, phi=0.5230636172671492)
ry(pi*-0.5) q[21];
ry(pi*-0.5) q[22];
rz(pi*0.4645196153) q[21];
rz(pi*0.4645196153) q[22];
u3(pi*0.5,pi*1.0,pi*0.2084455941) q[21];
u3(pi*0.5,0,pi*1.2084455941) q[22];
sx q[21];
cx q[21],q[22];
rx(pi*0.0354803847) q[21];
ry(pi*0.5) q[22];
cx q[22],q[21];
sxdg q[22];
s q[22];
cx q[21],q[22];
u3(pi*0.5,pi*0.3270347906,0) q[21];
u3(pi*0.5,pi*1.3270347906,pi*1.0) q[22];
ry(pi*0.5) q[21];
ry(pi*0.5) q[22];
sx q[21];
sx q[22];
...
sx q[21];
cx q[21],q[22];
rx(pi*0.4167518398) q[21];
ry(pi*0.5) q[22];
cx q[22],q[21];
sxdg q[22];
s q[22];
cx q[21],q[22];
u3(pi*0.5,pi*0.6667518398,pi*1.0) q[21];
u3(pi*0.5,pi*0.1667518398,0) q[22];

// Gate: cirq.FSimGate(theta=1.5376836849431186, phi=0.46265685930712236)
ry(pi*-0.5) q[24];
ry(pi*-0.5) q[25];
rz(pi*0.4894599187) q[24];
rz(pi*0.4894599187) q[25];
u3(pi*0.5,pi*1.0,pi*1.0) q[24];
u3(pi*0.5,0,pi*1.0) q[25];
sx q[24];
cx q[24],q[25];
rx(pi*0.0105400813) q[24];
ry(pi*0.5) q[25];
cx q[25],q[24];
sxdg q[25];
s q[25];
cx q[24],q[25];
u3(pi*0.5,pi*1.5105400813,0) q[24];
u3(pi*0.5,pi*1.5105400813,pi*1.0) q[25];
ry(pi*0.5) q[24];
ry(pi*0.5) q[25];
sx q[24];
sx q[25];
...
sxdg q[24];
sxdg q[25];
u3(pi*0.5,pi*1.0,pi*1.1233633886) q[24];
u3(pi*0.5,0,pi*1.6233633886) q[25];
sx q[24];
cx q[24],q[25];
rx(pi*0.4263658739) q[24];
ry(pi*0.5) q[25];
cx q[25],q[24];
sxdg q[25];
s q[25];
cx q[24],q[25];
u3(pi*0.5,pi*1.8030024853,0) q[24];
u3(pi*0.5,pi*1.3030024853,pi*1.0) q[25];

// Gate: cirq.FSimGate(theta=1.4749003996237158, phi=0.4353609222411594)
ry(pi*-0.5) q[28];
ry(pi*-0.5) q[29];
rz(pi*0.4694753783) q[28];
rz(pi*0.4694753783) q[29];
u3(pi*0.5,pi*1.0,pi*1.0) q[28];
u3(pi*0.5,0,pi*1.0) q[29];
sx q[28];
cx q[28],q[29];
rx(pi*0.0305246217) q[28];
ry(pi*0.5) q[29];
cx q[29],q[28];
sxdg q[29];
s q[29];
cx q[28],q[29];
u3(pi*0.5,pi*1.5305246217,0) q[28];
u3(pi*0.5,pi*1.5305246217,pi*1.0) q[29];
ry(pi*0.5) q[28];
ry(pi*0.5) q[29];
sx q[28];
sx q[29];
...
sxdg q[28];
sxdg q[29];
u3(pi*0.5,pi*1.0,pi*0.1488891613) q[28];
u3(pi*0.5,0,pi*1.6488891613) q[29];
sx q[28];
cx q[28],q[29];
rx(pi*0.4307101572) q[28];
ry(pi*0.5) q[29];
cx q[29],q[28];
sxdg q[29];
s q[29];
cx q[28],q[29];
u3(pi*0.5,pi*0.7818209959,0) q[28];
u3(pi*0.5,pi*1.2818209959,pi*1.0) q[29];
...
rz(pi*-1.5516585295) q[19];
rz(pi*1.6547680686) q[20];
rz(pi*-1.8933072152) q[21];
rz(pi*1.6064686216) q[22];
rz(pi*-2.3490397609) q[24];
rz(pi*2.4240356629) q[25];
rz(pi*-1.8655832225) q[28];
rz(pi*1.7648564628) q[29];
u2(pi*-0.25, pi*0.25) q[0];
...
rz(pi*5.3962214229) q[18];
rz(pi*-3.2786928386) q[13];
rz(pi*3.3390064432) q[19];
rz(pi*-5.3907558705) q[14];
rz(pi*5.417256899) q[20];
rz(pi*-5.6201447731) q[15];
rz(pi*5.6304691535) q[21];
rz(pi*4.3676522913) q[16];
rz(pi*-3.9105776028) q[22];
rz(pi*7.0181466269) q[23];
rz(pi*-7.0007660262) q[27];
rz(pi*5.7008732785) q[24];
rz(pi*-5.6833781959) q[28];
rz(pi*4.5863357897) q[25];
rz(pi*-4.7653755272) q[29];
...
u3(pi*0.5,pi*0.2627939242,pi*1.0) q[18];
ry(pi*0.5) q[12];
ry(pi*0.5) q[18];
sx q[12];
sx q[18];
...
u3(pi*0.5,0,pi*0.6004604229) q[18];
sx q[12];
cx q[12],q[18];
...
u3(pi*0.5,pi*0.3158701988,pi*1.0) q[18];
...
u3(pi*0.5,pi*1.0,pi*0.5463004968) q[19];
sx q[13];
cx q[13],q[19];
...
u3(pi*0.5,pi*0.3733996081,0) q[19];
...
u3(pi*0.5,pi*1.007498007,0) q[20];
ry(pi*0.5) q[14];
ry(pi*0.5) q[20];
sx q[14];
sx q[20];
...
u3(pi*0.5,pi*0.9169699457,pi*1.0) q[20];
...
u3(pi*0.5,pi*1.5185840452,pi*1.0) q[21];
ry(pi*0.5) q[15];
ry(pi*0.5) q[21];
sx q[15];
sx q[21];
...
u3(pi*0.5,pi*0.4183034977,pi*1.0) q[21];
...
u3(pi*0.5,pi*2.9273e-06,pi*1.0) q[22];
ry(pi*0.5) q[16];
ry(pi*0.5) q[22];
sx q[16];
sx q[22];
...
u3(pi*0.5,pi*1.0,pi*0.5812034819) q[22];
sx q[16];
cx q[16],q[22];
...
u3(pi*0.5,pi*0.336407121,0) q[22];

// Gate: cirq.FSimGate(theta=1.596346344028619, phi=0.5104319949477776)
ry(pi*-0.5) q[23];
ry(pi*-0.5) q[27];
rz(pi*0.5081328231) q[23];
rz(pi*0.5081328231) q[27];
u3(pi*0.5,0,pi*1.3029820329) q[23];
u3(pi*0.5,0,pi*1.3029820329) q[27];
sx q[23];
cx q[23],q[27];
rx(pi*0.0081328231) q[23];
ry(pi*0.5) q[27];
cx q[27],q[23];
sxdg q[27];
s q[27];
cx q[23],q[27];
u3(pi*0.5,pi*0.188885144,pi*1.0) q[23];
...
sxdg q[23];
sxdg q[27];
u3(pi*0.5,0,pi*1.0663696586) q[23];
u3(pi*0.5,pi*1.0,pi*0.5663696586) q[27];
sx q[23];
cx q[23],q[27];
rx(pi*0.4187622249) q[23];
ry(pi*0.5) q[27];
cx q[27],q[23];
sxdg q[27];
s q[27];
cx q[23],q[27];
u3(pi*0.5,pi*1.8523925663,pi*1.0) q[23];
u3(pi*0.5,pi*0.3523925663,0) q[27];

// Gate: cirq.FSimGate(theta=1.53597466118183, phi=0.5584919013659856)
ry(pi*-0.5) q[24];
ry(pi*-0.5) q[28];
rz(pi*0.4889159196) q[24];
rz(pi*0.4889159196) q[28];
u3(pi*0.5,pi*1.0,0) q[24];
u3(pi*0.5,0,0) q[28];
sx q[24];
cx q[24],q[28];
rx(pi*0.0110840804) q[24];
ry(pi*0.5) q[28];
cx q[28],q[24];
sxdg q[28];
s q[28];
cx q[24],q[28];
u3(pi*0.5,pi*0.5110840804,0) q[24];
u3(pi*0.5,pi*0.5110840804,pi*1.0) q[28];
ry(pi*0.5) q[24];
ry(pi*0.5) q[28];
sx q[24];
sx q[28];
...
sx q[24];
cx q[24],q[28];
rx(pi*0.4111132532) q[24];
ry(pi*0.5) q[28];
cx q[28],q[24];
sxdg q[28];
s q[28];
cx q[24],q[28];
u3(pi*0.5,pi*0.9111132532,pi*1.0) q[24];
u3(pi*0.5,pi*1.4111132532,0) q[28];

// Gate: cirq.FSimGate(theta=1.385350861888917, phi=0.5757363921651084)
ry(pi*-0.5) q[25];
ry(pi*-0.5) q[29];
rz(pi*0.4409708752) q[25];
rz(pi*0.4409708752) q[29];
u3(pi*0.5,0,pi*0.1833201262) q[25];
u3(pi*0.5,pi*1.0,pi*0.1833201262) q[29];
sx q[25];
cx q[25],q[29];
rx(pi*0.0590291248) q[25];
ry(pi*0.5) q[29];
cx q[29],q[25];
sxdg q[29];
s q[29];
cx q[25],q[29];
u3(pi*0.5,pi*0.3757089986,pi*1.0) q[25];
u3(pi*0.5,pi*0.3757089986,0) q[29];
ry(pi*0.5) q[25];
ry(pi*0.5) q[29];
sx q[25];
sx q[29];
...
u3(pi*0.5,0,pi*1.75) q[29];
sx q[25];
cx q[25],q[29];
rx(pi*0.4083687073) q[25];
ry(pi*0.5) q[29];
cx q[29],q[25];
sxdg q[29];
s q[29];
cx q[25],q[29];
u3(pi*0.5,pi*1.6583687073,0) q[25];
u3(pi*0.5,pi*1.1583687073,pi*1.0) q[29];
...
rz(pi*-4.7504169537) q[18];
rz(pi*2.9425087257) q[13];
rz(pi*-2.882195121) q[19];
rz(pi*4.4665314088) q[14];
rz(pi*-4.4400303802) q[20];
rz(pi*4.4864714964) q[15];
rz(pi*-4.476147116) q[21];
rz(pi*-4.8970165422) q[16];
rz(pi*5.3540912307) q[22];
rz(pi*-5.6292872619) q[23];
rz(pi*5.6466678627) q[27];
rz(pi*-5.7606277141) q[24];
rz(pi*5.7781227967) q[28];
rz(pi*-3.9857827027) q[25];
rz(pi*3.8067429652) q[29];
sx q[0];
sx q[1];
sx q[2];
ry(pi*0.5) q[3];
...
rz(pi*9.6022318167) q[18];
rz(pi*-9.605639326) q[23];
rz(pi*6.3304990043) q[19];
rz(pi*-6.2177071019) q[24];
rz(pi*9.8518523816) q[20];
rz(pi*-9.926465199) q[25];
rz(pi*6.4311046184) q[21];
rz(pi*-6.3866061638) q[26];
...
ry(pi*-0.5) q[18];
ry(pi*-0.5) q[23];
rz(pi*0.4852860754) q[18];
rz(pi*0.4852860754) q[23];
u3(pi*0.5,pi*1.0,pi*0.5) q[18];
u3(pi*0.5,0,pi*0.5) q[23];
sx q[18];
cx q[18],q[23];
rx(pi*0.0147139246) q[18];
ry(pi*0.5) q[23];
cx q[23],q[18];
sxdg q[23];
s q[23];
cx q[18],q[23];
u3(pi*0.5,pi*0.0147139246,0) q[18];
u3(pi*0.5,pi*0.0147139246,pi*1.0) q[23];
ry(pi*0.5) q[18];
ry(pi*0.5) q[23];
sx q[18];
sx q[23];
...
sxdg q[18];
sxdg q[23];
u3(pi*0.5,0,pi*1.4622238059) q[18];
u3(pi*0.5,pi*1.0,pi*1.9622238059) q[23];
sx q[18];
cx q[18],q[23];
rx(pi*0.4229864098) q[18];
ry(pi*0.5) q[23];
cx q[23],q[18];
sxdg q[23];
s q[23];
cx q[18],q[23];
u3(pi*0.5,pi*1.4607626039,pi*1.0) q[18];
u3(pi*0.5,pi*0.9607626039,0) q[23];
...
sx q[19];
cx q[19],q[24];
rx(pi*0.005270413) q[19];
ry(pi*0.5) q[24];
cx q[24],q[19];
sxdg q[24];
s q[24];
cx q[19],q[24];
u3(pi*0.5,pi*1.005270413,pi*1.0) q[19];
u3(pi*0.5,pi*0.005270413,0) q[24];
ry(pi*0.5) q[19];
ry(pi*0.5) q[24];
sx q[19];
sx q[24];
...
sxdg q[19];
sxdg q[24];
u3(pi*0.5,pi*1.0,pi*1.5642914329) q[19];
u3(pi*0.5,0,pi*0.0642914329) q[24];
sx q[19];
cx q[19],q[24];
rx(pi*0.4174537375) q[19];
ry(pi*0.5) q[24];
cx q[24],q[19];
sxdg q[24];
s q[24];
cx q[19],q[24];
u3(pi*0.5,pi*1.3531623046,0) q[19];
u3(pi*0.5,pi*0.8531623046,pi*1.0) q[24];
...
sx q[20];
cx q[20],q[25];
rx(pi*0.0190519967) q[20];
ry(pi*0.5) q[25];
cx q[25],q[20];
sxdg q[25];
rz(pi*0.5) q[25];
cx q[20],q[25];
u3(pi*0.5,pi*0.5190519967,pi*1.0) q[20];
u3(pi*0.5,pi*1.5190519967,0) q[25];
ry(pi*0.5) q[20];
ry(pi*0.5) q[25];
sx q[20];
sx q[25];
...
sxdg q[20];
sxdg q[25];
u3(pi*0.5,pi*1.0,pi*0.0696887327) q[20];
u3(pi*0.5,0,pi*0.5696887327) q[25];
sx q[20];
cx q[20],q[25];
rx(pi*0.4213871934) q[20];
ry(pi*0.5) q[25];
cx q[25],q[20];
sxdg q[25];
s q[25];
cx q[20],q[25];
u3(pi*0.5,pi*0.8516984607,0) q[20];
u3(pi*0.5,pi*0.3516984607,pi*1.0) q[25];
...
sx q[21];
cx q[21],q[26];
rx(pi*0.0026001214) q[21];
ry(pi*0.5) q[26];
cx q[26],q[21];
sxdg q[26];
s q[26];
cx q[21],q[26];
u3(pi*0.5,pi*0.4973998786,pi*1.0) q[21];
u3(pi*0.5,pi*1.4973998786,pi*1.0) q[26];
ry(pi*0.5) q[21];
ry(pi*0.5) q[26];
sx q[21];
sx q[26];
...
sx q[21];
cx q[21],q[26];
rx(pi*0.419122924) q[21];
ry(pi*0.5) q[26];
cx q[26],q[21];
sxdg q[26];
s q[26];
cx q[21],q[26];
u3(pi*0.5,pi*0.669122924,pi*1.0) q[21];
u3(pi*0.5,pi*0.169122924,0) q[26];
...
rz(pi*-10.0345610108) q[18];
rz(pi*10.0311535015) q[23];
rz(pi*-5.434421382) q[19];
rz(pi*5.5472132844) q[24];
rz(pi*-9.1798863435) q[20];
rz(pi*9.1052735261) q[25];
rz(pi*-6.5670035038) q[21];
rz(pi*6.6115019584) q[26];
ry(pi*0.5) q[0];
u2(pi*-0.25, pi*0.25) q[1];
ry(pi*0.5) q[2];
sx q[3];
...
rz(pi*-1.1134238777) q[18];
rz(pi*1.1694659584) q[19];
rz(pi*-3.587134634) q[20];
rz(pi*3.6604070452) q[21];
rz(pi*-5.292126244) q[23];
rz(pi*5.2506829187) q[24];
rz(pi*-6.349327549) q[25];
rz(pi*6.3741432051) q[26];
rz(pi*-7.4867954354) q[27];
rz(pi*7.5782819374) q[28];
...
rz(pi*1.6828295009) q[18];
rz(pi*-1.6267874203) q[19];
rz(pi*3.3053419494) q[20];
rz(pi*-3.2320695382) q[21];
rz(pi*5.3550627118) q[23];
rz(pi*-5.3965060371) q[24];
rz(pi*8.1631823577) q[25];
rz(pi*-8.1383667016) q[26];
rz(pi*7.345311792) q[27];
rz(pi*-7.25382529) q[28];
u2(pi*-0.25, pi*0.25) q[0];
ry(pi*0.5) q[1];
sx q[2];
ry(pi*0.5) q[3];
...
rz(pi*3.0011374803) q[19];
rz(pi*-2.8980279413) q[20];
rz(pi*5.5635737986) q[21];
rz(pi*-5.8504123921) q[22];
rz(pi*7.8680860328) q[24];
rz(pi*-7.7930901309) q[25];
rz(pi*4.3863074183) q[28];
rz(pi*-4.487034178) q[29];
...
rz(pi*-3.7716585295) q[19];
rz(pi*3.8747680686) q[20];
rz(pi*-5.5933072152) q[21];
rz(pi*5.3064686216) q[22];
rz(pi*-7.9036364711) q[24];
rz(pi*7.978632373) q[25];
rz(pi*-4.8255832225) q[28];
rz(pi*4.7248564628) q[29];
ry(pi*0.5) q[0];
sx q[1];
u2(pi*-0.25, pi*0.25) q[2];
sx q[3];
...
rz(pi*13.2402214229) q[18];
rz(pi*-8.1626928386) q[13];
rz(pi*8.2230064432) q[19];
rz(pi*-12.9387558705) q[14];
rz(pi*12.965256899) q[20];
rz(pi*-12.7241447731) q[15];
rz(pi*12.7344691535) q[21];
rz(pi*11.0276522913) q[16];
rz(pi*-10.5705776028) q[22];
rz(pi*17.0821466269) q[23];
rz(pi*-17.0647660262) q[27];
rz(pi*14.5808732785) q[24];
rz(pi*-14.5633781959) q[28];
rz(pi*10.8717390795) q[25];
rz(pi*-11.050778817) q[29];
...
rz(pi*-12.5944169537) q[18];
rz(pi*7.8265087257) q[13];
rz(pi*-7.766195121) q[19];
rz(pi*12.0145314088) q[14];
rz(pi*-11.9880303802) q[20];
rz(pi*11.5904714964) q[15];
rz(pi*-11.580147116) q[21];
rz(pi*-11.5570165422) q[16];
rz(pi*12.0140912307) q[22];
rz(pi*-15.6932872619) q[23];
rz(pi*15.7106678627) q[27];
rz(pi*-14.6406277141) q[24];
rz(pi*14.6581227967) q[28];
rz(pi*-10.2711859926) q[25];
rz(pi*10.0921462551) q[29];
u2(pi*-0.25, pi*0.25) q[0];
ry(pi*0.5) q[1];
sx q[2];
ry(pi*0.5) q[3];
...
rz(pi*20.4062318167) q[18];
rz(pi*-20.409639326) q[23];
rz(pi*13.1384990043) q[19];
rz(pi*-13.0257071019) q[24];
rz(pi*19.9944490918) q[20];
rz(pi*-20.0690619092) q[25];
rz(pi*13.8311046184) q[21];
rz(pi*-13.7866061638) q[26];
...
rz(pi*-20.8385610108) q[18];
rz(pi*20.8351535015) q[23];
rz(pi*-12.242421382) q[19];
rz(pi*12.3552132844) q[24];
rz(pi*-19.3224830537) q[20];
rz(pi*19.2478702363) q[25];
rz(pi*-13.9670035038) q[21];
rz(pi*14.0115019584) q[26];
ry(pi*0.5) q[0];
sx q[1];
u2(pi*-0.25, pi*0.25) q[2];
u2(pi*-0.25, pi*0.25) q[3];
...
rz(pi*-2.0014238777) q[18];
rz(pi*2.0574659584) q[19];
rz(pi*-6.843134634) q[20];
rz(pi*6.9164070452) q[21];
rz(pi*-10.176126244) q[23];
rz(pi*10.1346829187) q[24];
rz(pi*-12.3479242591) q[25];
rz(pi*12.3727399152) q[26];
rz(pi*-13.5547954354) q[27];
rz(pi*13.6462819374) q[28];
...
rz(pi*2.5708295009) q[18];
rz(pi*-2.5147874203) q[19];
rz(pi*6.5613419494) q[20];
rz(pi*-6.4880695382) q[21];
rz(pi*10.2390627118) q[23];
rz(pi*-10.2805060371) q[24];
rz(pi*14.1617790678) q[25];
rz(pi*-14.1369634118) q[26];
rz(pi*13.413311792) q[27];
rz(pi*-13.32182529) q[28];
sx q[0];
ry(pi*0.5) q[1];
ry(pi*0.5) q[2];
sx q[3];
...
rz(pi*5.2211374803) q[19];
rz(pi*-5.1180279413) q[20];
rz(pi*9.2635737986) q[21];
rz(pi*-9.5504123921) q[22];
rz(pi*13.422682743) q[24];
rz(pi*-13.347686841) q[25];
rz(pi*7.3463074183) q[28];
rz(pi*-7.447034178) q[29];
...
rz(pi*-5.9916585295) q[19];
rz(pi*6.0947680686) q[20];
rz(pi*-9.2933072152) q[21];
rz(pi*9.0064686216) q[22];
rz(pi*-13.4582331812) q[24];
rz(pi*13.5332290832) q[25];
rz(pi*-7.7855832225) q[28];
rz(pi*7.6848564628) q[29];
u2(pi*-0.25, pi*0.25) q[0];
sx q[1];
sx q[2];
u2(pi*-0.25, pi*0.25) q[3];
...
rz(pi*21.0842214229) q[18];
rz(pi*-13.0466928386) q[13];
rz(pi*13.1070064432) q[19];
rz(pi*-20.4867558705) q[14];
rz(pi*20.513256899) q[20];
rz(pi*-19.8281447731) q[15];
rz(pi*19.8384691535) q[21];
rz(pi*17.6876522913) q[16];
rz(pi*-17.2305776028) q[22];
rz(pi*27.1461466269) q[23];
rz(pi*-27.1287660262) q[27];
rz(pi*23.4608732785) q[24];
rz(pi*-23.4433781959) q[28];
rz(pi*17.1571423694) q[25];
rz(pi*-17.3361821069) q[29];
...
rz(pi*-20.4384169537) q[18];
rz(pi*12.7105087257) q[13];
rz(pi*-12.650195121) q[19];
rz(pi*19.5625314088) q[14];
rz(pi*-19.5360303802) q[20];
rz(pi*18.6944714964) q[15];
rz(pi*-18.684147116) q[21];
rz(pi*-18.2170165422) q[16];
rz(pi*18.6740912307) q[22];
rz(pi*-25.7572872619) q[23];
rz(pi*25.7746678627) q[27];
rz(pi*-23.5206277141) q[24];
rz(pi*23.5381227967) q[28];
rz(pi*-16.5565892824) q[25];
rz(pi*16.3775495449) q[29];
sx q[0];
ry(pi*0.5) q[1];
ry(pi*0.5) q[2];
ry(pi*0.5) q[3];
...
rz(pi*31.2102318167) q[18];
rz(pi*-31.213639326) q[23];
rz(pi*19.9464990043) q[19];
rz(pi*-19.8337071019) q[24];
rz(pi*30.1370458019) q[20];
rz(pi*-30.2116586193) q[25];
rz(pi*21.2311046184) q[21];
rz(pi*-21.1866061638) q[26];
...
rz(pi*-31.6425610108) q[18];
rz(pi*31.6391535015) q[23];
rz(pi*-19.050421382) q[19];
rz(pi*19.1632132844) q[24];
rz(pi*-29.4650797638) q[20];
rz(pi*29.3904669464) q[25];
rz(pi*-21.3670035038) q[21];
rz(pi*21.4115019584) q[26];
u2(pi*-0.25, pi*0.25) q[0];
u2(pi*-0.25, pi*0.25) q[1];
u2(pi*-0.25, pi*0.25) q[2];
u2(pi*-0.25, pi*0.25) q[3];
...
rz(pi*-2.8894238777) q[18];
rz(pi*2.9454659584) q[19];
rz(pi*-10.099134634) q[20];
rz(pi*10.1724070452) q[21];
rz(pi*-15.060126244) q[23];
rz(pi*15.0186829187) q[24];
rz(pi*-18.3465209693) q[25];
rz(pi*18.3713366254) q[26];
rz(pi*-19.6227954354) q[27];
rz(pi*19.7142819374) q[28];
...
rz(pi*3.4588295009) q[18];
rz(pi*-3.4027874203) q[19];
rz(pi*9.8173419494) q[20];
rz(pi*-9.7440695382) q[21];
rz(pi*15.1230627118) q[23];
rz(pi*-15.1645060371) q[24];
rz(pi*20.160375778) q[25];
rz(pi*-20.1355601219) q[26];
rz(pi*19.481311792) q[27];
rz(pi*-19.38982529) q[28];
ry(pi*0.5) q[0];
sx q[1];
sx q[2];
ry(pi*0.5) q[3];
...
rz(pi*7.4411374803) q[19];
rz(pi*-7.3380279413) q[20];
rz(pi*12.9635737986) q[21];
rz(pi*-13.2504123921) q[22];
rz(pi*18.9772794531) q[24];
rz(pi*-18.9022835512) q[25];
rz(pi*10.3063074183) q[28];
rz(pi*-10.407034178) q[29];
...
rz(pi*-8.2116585295) q[19];
rz(pi*8.3147680686) q[20];
rz(pi*-12.9933072152) q[21];
rz(pi*12.7064686216) q[22];
rz(pi*-19.0128298914) q[24];
rz(pi*19.0878257934) q[25];
rz(pi*-10.7455832225) q[28];
rz(pi*10.6448564628) q[29];
u2(pi*-0.25, pi*0.25) q[0];
ry(pi*0.5) q[1];
u2(pi*-0.25, pi*0.25) q[2];
u2(pi*-0.25, pi*0.25) q[3];
