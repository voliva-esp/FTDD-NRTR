...
// Qubits: [(2, 4), (2, 5), (3, 3), (3, 4), (3, 5), (3, 6), (4, 3), (4, 4), (4, 5), (4, 6), (5, 3), (5, 4), (5, 5), (5, 6), (6, 4), (6, 5)]
qreg q[16];
...
rz(pi*-0.3507308388) q[14];
rz(pi*0.3755464949) q[15];
...
ry(pi*-0.5) q[14];
ry(pi*-0.5) q[15];
rz(pi*0.4999188741) q[14];
rz(pi*0.4999188741) q[15];
u3(pi*0.5,0,pi*1.0) q[14];
u3(pi*0.5,pi*1.0,pi*2.0) q[15];
sx q[14];
cx q[14],q[15];
rx(pi*8.11259e-05) q[14];
ry(pi*0.5) q[15];
cx q[15],q[14];
sxdg q[15];
s q[15];
cx q[14],q[15];
u3(pi*0.5,pi*1.5000811259,pi*1.0) q[14];
u3(pi*0.5,pi*0.5000811259,0) q[15];
ry(pi*0.5) q[14];
ry(pi*0.5) q[15];
sx q[14];
sx q[15];
...
sx q[14];
cx q[14],q[15];
rx(pi*0.4237377408) q[14];
ry(pi*0.5) q[15];
cx q[15],q[14];
sxdg q[15];
s q[15];
cx q[14],q[15];
u3(pi*0.5,pi*1.1737377408,0) q[14];
u3(pi*0.5,pi*0.6737377408,pi*1.0) q[15];
...
rz(pi*2.1645856475) q[14];
rz(pi*-2.1397699914) q[15];
sx q[0];
sx q[1];
ry(pi*0.5) q[2];
sx q[3];
...
rz(pi*9.8518523816) q[11];
rz(pi*-9.926465199) q[14];
rz(pi*6.4311046184) q[12];
rz(pi*-6.3866061638) q[15];
...
ry(pi*-0.5) q[11];
ry(pi*-0.5) q[14];
rz(pi*0.4809480033) q[11];
rz(pi*0.4809480033) q[14];
u3(pi*0.5,0,0) q[11];
u3(pi*0.5,pi*1.0,pi*1.0) q[14];
sx q[11];
cx q[11],q[14];
rx(pi*0.0190519967) q[11];
ry(pi*0.5) q[14];
cx q[14],q[11];
sxdg q[14];
rz(pi*0.5) q[14];
cx q[11],q[14];
u3(pi*0.5,pi*0.5190519967,pi*1.0) q[11];
u3(pi*0.5,pi*1.5190519967,0) q[14];
ry(pi*0.5) q[11];
ry(pi*0.5) q[14];
sx q[11];
sx q[14];
...
sxdg q[11];
sxdg q[14];
u3(pi*0.5,pi*1.0,pi*0.0696887327) q[11];
u3(pi*0.5,0,pi*0.5696887327) q[14];
sx q[11];
cx q[11],q[14];
rx(pi*0.4213871934) q[11];
ry(pi*0.5) q[14];
cx q[14],q[11];
sxdg q[14];
s q[14];
cx q[11],q[14];
u3(pi*0.5,pi*0.8516984607,0) q[11];
u3(pi*0.5,pi*0.3516984607,pi*1.0) q[14];

// Gate: cirq.FSimGate(theta=1.57896484905089, phi=0.5081656554152614)
ry(pi*-0.5) q[12];
ry(pi*-0.5) q[15];
rz(pi*0.5026001214) q[12];
rz(pi*0.5026001214) q[15];
u3(pi*0.5,0,pi*1.0) q[12];
u3(pi*0.5,0,0) q[15];
sx q[12];
cx q[12],q[15];
rx(pi*0.0026001214) q[12];
ry(pi*0.5) q[15];
cx q[15],q[12];
sxdg q[15];
s q[15];
cx q[12],q[15];
u3(pi*0.5,pi*0.4973998786,pi*1.0) q[12];
u3(pi*0.5,pi*1.4973998786,pi*1.0) q[15];
ry(pi*0.5) q[12];
ry(pi*0.5) q[15];
sx q[12];
sx q[15];
...
sx q[12];
cx q[12],q[15];
rx(pi*0.419122924) q[12];
ry(pi*0.5) q[15];
cx q[15],q[12];
sxdg q[15];
s q[15];
cx q[12],q[15];
u3(pi*0.5,pi*0.669122924,pi*1.0) q[12];
u3(pi*0.5,pi*0.169122924,0) q[15];
...
rz(pi*-9.1798863435) q[11];
rz(pi*9.1052735261) q[14];
rz(pi*-6.5670035038) q[12];
rz(pi*6.6115019584) q[15];
sx q[0];
u2(pi*-0.25, pi*0.25) q[1];
sx q[2];
sx q[3];
...
rz(pi*-6.349327549) q[14];
rz(pi*6.3741432051) q[15];
...
rz(pi*8.1631823577) q[14];
rz(pi*-8.1383667016) q[15];
ry(pi*0.5) q[0];
sx q[1];
u2(pi*-0.25, pi*0.25) q[2];
u2(pi*-0.25, pi*0.25) q[3];
...
rz(pi*19.9944490918) q[11];
rz(pi*-20.0690619092) q[14];
rz(pi*13.8311046184) q[12];
rz(pi*-13.7866061638) q[15];
...
rz(pi*-19.3224830537) q[11];
rz(pi*19.2478702363) q[14];
rz(pi*-13.9670035038) q[12];
rz(pi*14.0115019584) q[15];
u2(pi*-0.25, pi*0.25) q[0];
u2(pi*-0.25, pi*0.25) q[1];
sx q[2];
sx q[3];
...
rz(pi*-12.3479242591) q[14];
rz(pi*12.3727399152) q[15];
...
rz(pi*14.1617790678) q[14];
rz(pi*-14.1369634118) q[15];
sx q[0];
sx q[1];
ry(pi*0.5) q[2];
ry(pi*0.5) q[3];
...
rz(pi*30.1370458019) q[11];
rz(pi*-30.2116586193) q[14];
rz(pi*21.2311046184) q[12];
rz(pi*-21.1866061638) q[15];
...
rz(pi*-29.4650797638) q[11];
rz(pi*29.3904669464) q[14];
rz(pi*-21.3670035038) q[12];
rz(pi*21.4115019584) q[15];
u2(pi*-0.25, pi*0.25) q[0];
ry(pi*0.5) q[1];
sx q[2];
sx q[3];
...
rz(pi*-18.3465209693) q[14];
rz(pi*18.3713366254) q[15];
...
rz(pi*20.160375778) q[14];
rz(pi*-20.1355601219) q[15];
ry(pi*0.5) q[0];
u2(pi*-0.25, pi*0.25) q[1];
ry(pi*0.5) q[2];
ry(pi*0.5) q[3];
