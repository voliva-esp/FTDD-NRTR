...
class OutputHandler:
    ...
    """
    def __init__(self, tool, circuit=None, sep="#"):
        """
            Input variables:
...
class PrintOutputHandler(OutputHandler):
    def __init__(self, tool, circuit=None, sep="#"):
        """
            ...
            sep --------> Separator for the file
        """
        super().__init__(tool, circuit, sep)
    ...
    def print_init(self, n_slices=0):
        ...
        if self.circuit is not None:
            text = f"Circuit {self.circuit} {self.sep} {text}"
        print(text)
...
class FileOutputHandler(OutputHandler):
    def __init__(self, tool, circuit=None, sep="#", file_name=None):
        """
            Input variables:
            tool -------> Name of the tool used to simulate
            circuit ----> Name of the circuit
